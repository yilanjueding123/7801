...
extern INT32S jpeg_multi_vlc_input_output_restart(INT32U addr, INT32U len); // Decompression: Second, third, ... VLC addresses(16-byte alignment) and lengths(Maximum=0x000FFFFF) && Restart JPEG engine when FIFO is full

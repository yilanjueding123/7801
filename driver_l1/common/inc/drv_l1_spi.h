...
#define drv_l1_spi_init spi_init
#define drv_l1_spi_clk_set spi_clk_rate_set
#define drv_l1_spi_transceive_cpu spi_transceive_cpu
#define drv_l1_spi_transceive spi_transceive
#endif

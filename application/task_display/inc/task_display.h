...
#define DISPLAY_BUFF_SRC_THUMBNAIL_JPEG			5
...
extern INT16U icon_manu_osd_mode[];
extern INT16U icon_manu_rotate[];
...
extern const INT16U ALIGN4 hdmi_bat4[];

...
static INT32U super_plug_out_flag=0;
static INT32U super_usbh_plug_out_flag=0;
//static INT32U super_cf_plug_out_flag=0;

void fs_sd_ms_plug_out_flag_en(void)
{
    super_plug_out_flag=1;
}

INT32U fs_sd_ms_plug_out_flag_get(void)
{
#if SUPPORT_STG_SUPER_PLUGOUT == 1
    return super_plug_out_flag;
#else
    return 0;
#endif
}
...
{
    super_cf_plug_out_flag=1;
}

INT8U fs_cf_plug_out_flag_get(void)
{
#if SUPPORT_STG_SUPER_PLUGOUT == 1
    return super_cf_plug_out_flag;
#else
    return 0;
#endif
}

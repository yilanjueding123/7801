...
#define DE_INVLDFUNC    -1      /* Invalid function number      */ /*0xFFFFFFFF*/
#define DE_FILENOTFND   -2      /* File not found               */ /*0xFFFFFFFE*/
#define DE_PATHNOTFND   -3      /* Path not found               */  /*0xFFFFFFFD*/
#define DE_TOOMANY      -4      /* Too many open files          */ /*0xFFFFFFFC*/
#define DE_ACCESS       -5      /* Access denied                */ /*0xFFFFFFFB*/
#define DE_INVLDHNDL    -6      /* Invalid handle               */ /*0xFFFFFFFA*/
#define DE_MCBDESTRY    -7      /* Memory control blocks shot   */  /*0xFFFFFFF9*/
#define DE_NOMEM        -8      /* Insufficient memory          */ /*0xFFFFFFF8*/
...
#define DE_RMVCUDIR     -16     /* Attempt remove current dir   */ /*0xFFFFFFF1*/
#define DE_DEVICE       -17     /* Not same device              */ /*0xFFFFFFF0*/
#define DE_MAX_FILE_NUM -18     /* No more files                */ /*0xFFFFFFEF*/
#define DE_WRTPRTCT     -19     /* No more files                */ /*0xFFFFFFEE*/
#define DE_BLKINVLD     -20     /* invalid block                */ /*0xFFFFFFED*/

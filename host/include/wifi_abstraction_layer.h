...
*
*******************************************************/
#ifndef __WIFI_ABSTRACTION_LAYER_H__
#define __WIFI_ABSTRACTION_LAYER_H__
...
// Typedef
typedef struct netconn *netconn_ptr;
typedef struct netbuf *netbuf_ptr;
...
#endif	//__WIFI_ABSTRACTION_LAYER_H__

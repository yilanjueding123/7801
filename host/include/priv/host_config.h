...
#define TX_TASK_SLEEP               0               // Tx task go to sleep 1 tick when get no tx resource 200 time
#define TX_TASK_RETRY_CNT           200             // Tx task retry count when tx resource of wifi-chip is not enough

#define TX_RESOURCE_PAGE            90
#define RX_RESOURCE_PAGE            31
// ------------------------- iperf3 ---------------------------
...
#define RC_DEFAULT_RATE_MSK 0x01E0
#define RC_DEFAULT_RESENT_REPORT 0  // feature, 0 or 1
...
#define AP_RX_SUPPORT_BASIC_RATE     0x0FF
#define AP_RX_SUPPORT_MCS_RATE       0x1F
